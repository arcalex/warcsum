...
pkgdatadir = $(datadir)/warcsum
pkgincludedir = $(includedir)/warcsum
pkglibdir = $(libdir)/warcsum
pkglibexecdir = $(libexecdir)/warcsum
...
ACLOCAL = ${SHELL} /afs/archive.bibalex.org/user/w/ws/wsl/warcsum/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /afs/archive.bibalex.org/user/w/ws/wsl/warcsum/missing --run autoconf
AUTOHEADER = ${SHELL} /afs/archive.bibalex.org/user/w/ws/wsl/warcsum/missing --run autoheader
AUTOMAKE = ${SHELL} /afs/archive.bibalex.org/user/w/ws/wsl/warcsum/missing --run automake-1.11
AWK = mawk
CC = gcc
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lrt -lpthread -lmysqlclient -lm -ldl -lcurl -lcrypto -lgzmulti 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /afs/archive.bibalex.org/user/w/ws/wsl/warcsum/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = warcsum
PACKAGE_BUGREPORT = archive@bibalex.org
PACKAGE_NAME = warcsum
PACKAGE_STRING = warcsum 0.1
PACKAGE_TARNAME = warcsum
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
SET_MAKE = 
...
STRIP = 
VERSION = 0.1
abs_builddir = /afs/archive.bibalex.org/user/w/ws/wsl/warcsum
abs_srcdir = /afs/archive.bibalex.org/user/w/ws/wsl/warcsum
abs_top_builddir = /afs/archive.bibalex.org/user/w/ws/wsl/warcsum
abs_top_srcdir = /afs/archive.bibalex.org/user/w/ws/wsl/warcsum
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /afs/archive.bibalex.org/user/w/ws/wsl/warcsum/install-sh
